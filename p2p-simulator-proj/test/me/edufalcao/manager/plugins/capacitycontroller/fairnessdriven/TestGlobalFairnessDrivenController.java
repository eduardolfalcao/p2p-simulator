...
public class TestGlobalFairnessDrivenController {
	...
	public void testGetMaxCapacityToSupplyForTwoConsumers() {
		...
		mockedAccountingPlugin.updateAll();
		assertEquals(3.5,mockedFdController.getMaxCapacityToSupply(peer2), ACCEPTABLE_ERROR);
		assertEquals(3.5,mockedFdController.getMaxCapacityToSupply(peer3), ACCEPTABLE_ERROR);
		
		doReturn(50).when(mockedAccountingPlugin).getTime();
		doReturn(50).when(mockedFdController).getTime();
		mockedAccountingPlugin.updateAll();
		assertEquals(3,mockedFdController.getMaxCapacityToSupply(peer2), ACCEPTABLE_ERROR);
		assertEquals(3,mockedFdController.getMaxCapacityToSupply(peer3), ACCEPTABLE_ERROR);
		...
		mockedAccountingPlugin.updateAll();
		assertEquals(2,mockedFdController.getMaxCapacityToSupply(peer2), ACCEPTABLE_ERROR);
		assertEquals(2,mockedFdController.getMaxCapacityToSupply(peer3), ACCEPTABLE_ERROR);
		
		doReturn(80).when(mockedAccountingPlugin).getTime();
		doReturn(80).when(mockedFdController).getTime();
		mockedAccountingPlugin.updateAll();		
		assertEquals(1.5,mockedFdController.getMaxCapacityToSupply(peer2), ACCEPTABLE_ERROR);
		assertEquals(1.5,mockedFdController.getMaxCapacityToSupply(peer3), ACCEPTABLE_ERROR);
		
		doReturn(90).when(mockedAccountingPlugin).getTime();
		doReturn(90).when(mockedFdController).getTime();
		mockedAccountingPlugin.updateAll();
		assertEquals(1.0,mockedFdController.getMaxCapacityToSupply(peer2), ACCEPTABLE_ERROR);
		assertEquals(1.0,mockedFdController.getMaxCapacityToSupply(peer3), ACCEPTABLE_ERROR);
	...
	public void testUpdateFairness() {
		...
		mockedAccountingPlugin.updateAll();				
		assertEquals(-1, mockedFdController.getCurrentFairness(null), ACCEPTABLE_ERROR);
		...
		assertEquals(-1, mockedFdController.getCurrentFairness(null), ACCEPTABLE_ERROR);
		mockedFdController.updateFairness();
		assertEquals(35.0/20.0, mockedFdController.getCurrentFairness(null), ACCEPTABLE_ERROR);
		
		doReturn(120).when(mockedAccountingPlugin).getTime();
		mockedAccountingPlugin.updateAll();		
		assertEquals(35.0/20.0, mockedFdController.getCurrentFairness(null), ACCEPTABLE_ERROR);
		mockedFdController.updateFairness();
		assertEquals(4, mockedFdController.getCurrentFairness(null), ACCEPTABLE_ERROR);
	}
